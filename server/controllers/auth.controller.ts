...
export class AuthController {
  async register(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      // Create Zero-Trust Email MFA Challenge
  ...
  async login(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      // Enforce Email MFA Verification for Zero-Trust Session Issue
      const challenge = authService.createMfaChallenge(user.id, user.email);
  ...
  async verifyEmailMfa(req: AuthenticatedRequest, res: Response) {
    try {
  ...
  async resendEmailMfa(req: AuthenticatedRequest, res: Response) {
    try {
  ...
  async githubCallback(req: AuthenticatedRequest, res: Response) {
    ...
    try {
      ...
      // Check if user exists or register them via OAuth
