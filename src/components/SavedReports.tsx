...
export default function SavedReports({ onNavigateToTool, selectedProjectId, setSelectedProjectId }: SavedReportsProps) {
  ...
  const [newEvidenceType, setNewEvidenceType] = useState<Evidence['type']>('Note');
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase ${
                            f.severity.toUpperCase() === 'CRITICAL' ? 'bg-red-500/15 text-red-500 border border-red-500/35' :
                            f.severity.toUpperCase() === 'HIGH' ? 'bg-orange-500/15 text-orange-400 border border-orange-500/35' :
                            f.severity.toUpperCase() === 'MEDIUM' ? 'bg-yellow-500/15 text-yellow-400 border border-yellow-500/35' :
